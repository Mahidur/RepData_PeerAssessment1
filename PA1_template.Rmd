...
For simplicity, the missing values are imputed using the mean steps (37.38) for each interval as follows:
```{r, echo = TRUE}
 newtable <- mytable2                                     ## makes a copy the table 
 replacement <- mean(mytable2$steps, na.rm = TRUE)        ## calculates the mean for steps to be used as replacement
 ...
 miss_val
 summary(newtable)                                ## to confirm that the mean, median and other features are not changing in the table
 ```
